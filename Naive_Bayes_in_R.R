...
#Importing Data
dataset <- read.csv('/Users/mertcelik/Desktop/Social_Network_Ads.csv')
dataset <- dataset[,3:5]
...
set.seed(123)
split = sample.split(dataset$Purchased, SplitRatio = 0.75)  #oluşturulan set'in dependent değeri üzerinden split yapilir.
...
#Fitting the Kernel Naive Bayes model to fit Training set and Predicting the Test set results
library(e1071)
